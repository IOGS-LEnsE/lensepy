...
class DataSet:
    ...
    def get_image_from_set(self, image_index: int, set_index: int) -> np.ndarray:
        """
        Get an image from a set, specified by its index.
        :param set_index: Index of the set to get image from.
        :param image_index: Index of the image to get.
        :return: Image from the set.
        """
        return self.images_sets.get_image_from_set(image_index, set_index)
    ...
    def load_masks_from_file(self, filename: str = '') -> bool:
        """
        Load a set of masks from a MAT file.
        :param filename: Path of the MAT file.
        :return: True if file is loaded.
        """
...
if __name__ == '__main__':
    ...
    number_of_images = 5
    data_set = DataSet(number_of_images)

    images_set = ImagesSet(number_of_images)
